...
toastTrigger2 && toastLiveExample2 && toastTrigger2.addEventListener("click", function() {
...
var toastTrigger3 = document.getElementById("borderedToast2Btn"),
    toastLiveExample3 = document.getElementById("borderedToast2");
        toastTrigger3 && toastLiveExample3 && toastTrigger3.addEventListener("click", function() {
...
toastTrigger4 && toastLiveExample4 && toastTrigger4.addEventListener("click", function() {
...
}), toastPlacement = document.getElementById("toastPlacement"), toastPlacement && document.getElementById("selectToastPlacement").addEventListener("change", function() {
