...
@endsection
    ...
    @section('content')
        ...
        @include('admin.templates.brand.list')


        @include('admin.templates.brand.add')
        @include('admin.templates.brand.update')
...
{
  var API_URL = "{{ route('admin.brand.list') }}";
    $.ajax({
     url: API_URL,
     method: 'post',
     data: {},
...
function add_row(form)
{
     ...
     var API_URL = "{{ route('admin.brand.store') }}";
    ...
    function get_row(id)
    {
     var API_URL = "{{route('admin.brand.get')}}";
        $.ajax({
            url: API_URL,
            type: 'POST',
     ...
     function update_row()
     {
         ...
         var formData = new FormData(form);
         var API_URL = "{{ route('admin.brand.update') }}";
            $.ajax({
                url: API_URL,
                 type: 'POST',
                 data: formData,
    ...
    if(t.value == true){ 
        var API_URL = "{{ route('admin.brand.delete') }}";
        $.ajax({
            type: "POST",
            url: API_URL,
